                            ...
                            <tbody>
                                <c:forEach items="${issuedBooks}" var="book">
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge bg-${book.overdue ? 'danger' : (book.status == 'issued' ? 'success' : 'secondary')}">
                                                ${book.overdue ? 'Overdue' : (book.status == 'issued' ? 'Issued' : 'Returned')}
                                            </span>
                                        </td>
                                        <td>
